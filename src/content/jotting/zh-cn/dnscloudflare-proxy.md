---
title: "解决启用 DNS 启用 Cloudflare Proxy 后无法访问的问题"
timestamp: 2025-12-15
description: "解决 Caddy 反向代理与 Cloudflare Proxy 冲突问题"
tags:
  - cloudflare
  - dns
  - else
...
1. **Cloudflare 端**：默认的 SSL 设置可能是 **"Flexible"**。在这种模式下，Cloudflare 会通过 **HTTP (80 端口)** 连接源服务器（Caddy），但对访客展示 HTTPS。
